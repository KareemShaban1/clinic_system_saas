...
Route::group(
          ...
          function(){
              ...
              Route::group([
               ...
               function(){
                  Route::get('/', 'index')->name('index');
                  Route::get('/report', 'today_reservation_report')->name('today_reservation_report');
                  Route::get('/today_reservations', 'today_reservations')->name('today_reservations');
              ...
              Route::group([
               ...
               function(){
                  ...
                  Route::get('/english_prescription/{reservation_id}', 'english_drug_pdf')->name('english_drug_pdf');
                  Route::post('/store', 'store')->name('store');
                  Route::get('/show/{reservation_id}','show')->name('show');
             ...
             // Events Part
              ...
              Route::group([
                  ...
                  'controller'=>'ReservationControlController'],
                    function(){
                  Route::get('/', 'index')->name('index');
                  Route::post('/update', 'update')->name('update');
