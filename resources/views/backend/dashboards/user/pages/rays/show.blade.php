                    ...
                    @forelse($rays as $ray)
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-6 col-4"><span>{{ $ray->ray_name }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-6 col-4"><span>{{ $ray->ray_type }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-6 col-4"><span>{{ $ray->ray_date }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-3 col-md-4 col-sm-6 col-8">
                                    <h5 class="f-w-500"> {{ trans('backend/rays_trans.Notes') }} <span
                                            class="{{ trans('backend/rays_trans.pull') }}">:</span></h5>
                                </div>
                                <div class="col-lg-9 col-md-8 col-sm-6 col-4"><span>{{ $ray->notes }}</span>
                                </div>
                            </div>
