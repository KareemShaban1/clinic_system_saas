        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data"
                    action="{{ Route('backend.analysis.update', $analysis->id) }}" autocomplete="off">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <select name="reservation_id" class="custom-select mr-sm-2">
                                    ...
                                    <option value="{{ $analysis->reservation_id }}" selected>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <select name="patient_id" class="custom-select mr-sm-2">
                                    ...
                                    <option value="{{ $analysis->patient_id }}" selected>{{ $analysis->patient->name }}
                                    </option>
