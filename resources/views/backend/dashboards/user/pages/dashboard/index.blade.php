        ...
        <div class="col-md-12 col-sm-12 mb-30">
            <div class="card card-statistics ">
                <div class="card-body" style="background: white">
                    ...
                    @include('backend.dashboards.user.pages.dashboard.reservations_add')
                                                    ...
                                                    <table style="text-align: center"
                                                        ...
                                                        <tbody>
                                                            @foreach ($online_reservations as $online_reservation)
                                                                ...
                                                                @include('backend.dashboards.user.pages.online_reservations.delete')
                                                            @endforeach
                                                        </tbody>
                                                    </table>
                                                </div>
                    ...
                    @include('backend.dashboards.user.pages.dashboard.charts')
