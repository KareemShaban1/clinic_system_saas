        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#"
                        class="default-color">{{ trans('backend/settings_trans.Edit_Settings') }}</a></li>
                <li class="breadcrumb-item active">{{ trans('backend/settings_trans.Settings') }}</li>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ Route('backend.settings.update') }}"
                    autocomplete="off">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <h5>{{ trans('backend/settings_trans.Doctor_Name') }}<span class="text-danger">*</span></h5>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-6 col-6"><input type="text" name="doctor_name"
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <h5> {{ trans('backend/settings_trans.Doctor_Address') }} <span class="text-danger">*</span></h5>
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <h5> {{ trans('backend/settings_trans.Clinic_Name') }} <span class="text-danger">*</span></h5>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-6 col-6">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <h5> {{ trans('backend/settings_trans.Clinic_Type') }} <span class="text-danger">*</span></h5>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-6 col-6">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <h5> {{ trans('backend/settings_trans.Clinic_Address') }} <span class="text-danger">*</span></h5>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-6 col-6">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <h5> {{ trans('backend/settings_trans.Specifications') }} <span class="text-danger">*</span></h5>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-6 col-6">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <h5> {{ trans('backend/settings_trans.Qualifications') }} <span class="text-danger">*</span></h5>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-6 col-6">
