    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{trans('backend/drugs_trans.Add_Prescription')}}</a></li>
                        ...
                        <table class="table table-bordered table-responsive" id="table">
                            ...
                            <tbody id="tbody">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="drug_name[]" class="form-control" placeholder="{{trans('backend/drugs_trans.Drug_Name')}}">
                                        @error('drug_name')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror 
                                    </td>
                                    <td>
                                        <input type="text" name="drug_dose[]" class="form-control" placeholder="{{trans('backend/drugs_trans.Drug_Dose')}}">
                                        @error('drug_dose')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror 
                                    </td>
                                    <td>
                                        <input type="text" name="drug_type[]" class="form-control" placeholder="{{trans('backend/drugs_trans.Drug_Type')}}">
                                        @error('drug_type')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror 
                                    </td>
                                    <td>
                                        <input type="text" name="frequency[]" class="form-control" placeholder="{{trans('backend/drugs_trans.Frequency')}}">
                                        @error('frequency')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror 
                                    </td>
                                    <td>
                                        <input type="text" name="period[]" class="form-control" placeholder="{{trans('backend/drugs_trans.Period')}}">
                                        @error('period')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror 
                                    </td>
                                    <td>
                                        <input type="text" name="notes[]" class="form-control" placeholder="{{trans('backend/drugs_trans.Notes')}}">
                                        @error('notes')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror 
                                    </td>
