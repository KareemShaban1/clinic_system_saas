                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td style="width: 150px">
                                        <form action="{{Route('backend.medicines.restore',$medicine->id)}}" method="post" style="display:inline">
                                                  @csrf
                                                  @method('put')
                                              ...
                                              <form action="{{Route('backend.medicines.forceDelete',$medicine->id)}}" method="post" style="display:inline">
                                                  @csrf
                                                  @method('delete')
