    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{Route('admin.users.store')}}" autocomplete="off">
                   ...
                   <div class="row">
                       <div class="col-md-6">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="power">{{trans('users_trans.User_Power')}}<span class="text-danger">*</span></label>
                                        
                                        <select class="custom-select mr-sm-2" name="power"> 
                                            <option selected disabled> {{trans('users_trans.Choose')}} </option>
                                            <option value="Admin" >{{trans('users_trans.Admin')}}</option>
                                            <option value="Doctor" >{{trans('users_trans.Doctor')}}</option>
                                        </select>
