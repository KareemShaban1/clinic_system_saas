...
<script>
    function magnify(imgID, zoom) {
      ...
      function moveMagnifier(e) {
        ...
        if (x > img.width - (w / zoom)) {x = img.width - (w / zoom) - 25;}
        if (x < w / zoom) {x = w / zoom  + 30;}
        if (y > img.height - (h / zoom)) {y = img.height - (h / zoom) - 25;}
        if (y < h / zoom) {y = h / zoom + 30;}
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{trans('rays_trans.All_Rays')}}</a></li>
            ...
            <div class="card-body">
                ...
                <div class="my-post-content pt-4">
                    ...
                    <h5 class="card-header">
                       ...
                       <h5>  {{trans('rays_trans.Rays_Number')}}    {{$loop->index+1}} </h5>
                        </span>
                    </h5>
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                              ...
                              {{-- <div class="col-lg-9 col-md-8 col-sm-6 col-6"> --}}
                                 <div class="img-magnifier-container">
                                    <img  src="{{ URL::to($value)}}" id="{{$value}}"   width="350" height="350">
