                ...
                <table id="table_id" class="display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $patient->age }}</td>
                            <td>
                                <a href="{{Route('admin.reservations.add',$patient->patient_id)}}" class="btn btn-info btn-sm">
                                    {{trans('patients_trans.Add_Reservation')}}
                                </a>
                            </td>
                            <td>
                                <a href="{{Route('admin.patients.patient_pdf',$patient->patient_id)}}" class="btn btn-primary btn-sm">
                                    عرض كارت المريض
                                </a>
                            </td>
                            <td>
                                <a href="{{Route('admin.patients.show',$patient->patient_id)}}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-eye"></i>
                                </a>
                                <a href="{{Route('admin.patients.edit',$patient->patient_id)}}" class="btn btn-warning btn-sm">
