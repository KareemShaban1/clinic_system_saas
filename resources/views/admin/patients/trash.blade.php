                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{Route('admin.patients.restore',$patient->patient_id)}}" method="post" style="display:inline">
                                    @csrf
                                    @method('put')
                                ...
                                <form action="{{Route('admin.patients.forceDelete',$patient->patient_id)}}" method="post" style="display:inline">
                                    @csrf
                                    @method('delete')
