    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form action="{{Route('admin.drugs.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                        ...
                        <table class="table table-bordered table-responsive" id="table">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>{{trans('drugs_trans.Quantity')}}</th>
                            ...
                            <tbody id="tbody">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="quantity[]" class="form-control" placeholder="{{trans('drugs_trans.Quantity')}}">
                                    </td>
                                    <td>
...
<script>
    ...
    $('thead').on('click', '.addRow', function() {
        var tr = '<tr>' +
            ...
            '<td><input type="text" name="quantity[]" class="form-control" placeholder="{{trans('drugs_trans.Quantity')}}"></td>' +
