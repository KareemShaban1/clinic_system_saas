    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{Route('admin.medicines.store')}}" autocomplete="off">
                    ...
                    <div class="row">
                              ...
                              <div class="col-md-4">
                                        <div class="form-group">
                                                  ...
                                                  <input  class="form-control" name="brand_name" type="number" >
                                        </div>
                              </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input  class="form-control" name="categories" type="phone" >
                            </div>
                        </div>
                    </div>
