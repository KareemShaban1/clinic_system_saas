            ...
            <div class="card-body">
                ...
                <table id="table_id" class="display">
                    ...
                    <tbody>
                        ...
                        <td>
                            <form action="{{Route('admin.reservations.restore',$reservation->reservation_id)}}" method="post" style="display:inline">
                                @csrf
                                @method('put')
                            ...
                            <form action="{{Route('admin.reservations.forceDelete',$reservation->reservation_id)}}" method="post" style="display:inline">
                                @csrf
                                @method('delete')
