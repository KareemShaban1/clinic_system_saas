...
<body>
  ...
  <div class="top">
    <div class="doc-details">
      <p class="doc-name">{{trans('drugs_trans.Doctor')}} : {{$settings['doctor_name']}}</p>
      {{-- <p class="doc-meta">Benha , Egypt</p> --}}
      <p class="doc-meta">{{trans('drugs_trans.Clinic_Name')}} : {{$settings['clinic_name']}} </p>
      <p class="doc-meta">{{trans('drugs_trans.Clinic_Address')}}  : {{$settings['clinic_address']}} </p>
        </p>
    </div>
  </div>
          ...
          <div class="container">
                    ...
                    <thead>
                              <tr>
                                <th scope="col">{{trans('drugs_trans.Drug_Type')}}</th>
                                  <th scope="col">{{trans('drugs_trans.Drug_Name')}}</th>
                                  <th scope="col">{{trans('drugs_trans.Drug_Dose')}}</th>
                                  <th scope="col">{{trans('drugs_trans.Frequency')}}</th>
                                  <th scope="col">{{trans('drugs_trans.Period')}}</th>
