    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{trans('frontend/reservations_trans.Edit_Reservation')}}</a></li>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{Route('backend.reservations.update',$reservation->reservation_id)}}" autocomplete="off" >
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label">{{trans('frontend/reservations_trans.Patient_Name')}}</label>
                                <select name="patient_id" class="custom-select mr-sm-2" >
                                    <option value="" selected>{{trans('frontend/reservations_trans.Choose')}}</option> 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label> {{trans('frontend/reservations_trans.Number_of_Reservation')}}  <span class="text-danger">*</span></label>
                                <select name="res_num" class="custom-select mr-sm-2" value="{{ old('res_num', $reservation->res_num) }}">
                                    @for($i = 1 ; $i <= $number_of_res ; $i++ )
                                       @if($today_reservation_res_num == $i)
                                       <option value="{{ $i }}" selected style="background:gainsboro" >{{ $i }}</option>
                                       @else
                    ...
                    <div class="row">    
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label> {{trans('frontend/reservations_trans.Cost')}}<span class="text-danger">*</span></label>
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label> {{trans('frontend/reservations_trans.Reservation_Date')}}<span class="text-danger">*</span></label>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                <label for="status"> {{trans('frontend/reservations_trans.Reservation_Status')}}<span class="text-danger">*</span></label>
                   ...
                   <button type="submit" class="btn btn-success btn-md nextBtn btn-lg " >{{trans('frontend/reservations_trans.Edit')}}</button>
