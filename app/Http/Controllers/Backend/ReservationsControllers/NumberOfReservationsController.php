...
class NumberOfReservationsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.dashboards.user.pages.num_of_reservations.index');
    }
    ...
    public function data()
    {
        ...
        return DataTables::of($num_of_reservations)
            ->addColumn('action', function ($number) {
                $editUrl = route('backend.num_of_reservations.edit', $number->id);
                $deleteUrl = route('backend.num_of_reservations.destroy', $number->id);
