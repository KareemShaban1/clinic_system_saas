...
class ReservationController extends Controller
{
    ...
    public function index()
    {
        ...
        $reservationControls = ReservationControl::all();
        $settings = $reservationControls->pluck('value', 'key');

        $clinic_type = Settings::where('key', 'clinic_type')->pluck('value')->first();
    ...
    {
        $reservation = Reservation::findOrFail($id);
        $chronicDiseases = ChronicDisease::where('reservation_id', $id)->get();
        $drugs = Drug::where('reservation_id', $id)->get();
        $rays = Ray::where('reservation_id', $id)->get();

        return view('backend.pages.reservations.show', compact('reservation', 'chronicDiseases', 'drugs', 'rays'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.reservations.edit', compact('reservation', 'patients', 'numberOfRes', 'todayReservationResNum', 'settings', 'slots', 'todayReservationSlots'));
    }
